...
begin
  ...
  begin
    ...
    if Crypt(Name.Text) = DataModule1.ADOQuery2.FieldByName('Usuario').AsString then
    begin
      Tip.Text := DataModule1.ADOQuery2.FieldByName('Dica').AsString;
      // Sai da função
      Exit;
    end;
  end;
