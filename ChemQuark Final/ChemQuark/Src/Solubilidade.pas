...
procedure TSoluct.OnShow(Sender: TObject);
begin
...
begin
  With DataModule1.ADOQuery4.Fields do
...
begin
  ...
  ID := 0;
  // Limpa comandos SQL
  DB_Integrator.DataModule1.ADOQuery4.SQL.Clear;
  // Adiciona comando SQL ( Obtém a quantidade de coeficientes )
  DB_Integrator.DataModule1.ADOQuery4.SQL.Add('Select Count(*) as Codigo from' +
                                              ' Coeficiente');
  // Ativa o SQL
  ...
  while ID = 0 do
    ID := Random(DataModule1.AdoQuery4.FieldByName('Codigo').AsInteger);

  // Limpa comandos SQL
  DataModule1.ADOQuery4.SQL.Clear;

  // Adiciona comando SQL ( Seleciona valores relacionados à solubilidade )
  DataModule1.ADOQuery4.SQL.Add('SELECT Solubilidade.ID, Solubilidade.Substancia, Solubilidade.Nome, Coeficiente.ID_Substancia, Coeficiente.Massa, Coeficiente.Temperatura, Coeficiente.Medida, Coeficiente.Codigo' +
