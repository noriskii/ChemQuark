...
uses DB_Integrator, Sound, Register, Login, Tip;
...
begin
  ...
  DB_Integrator.DataModule1.ADOQuery1.SQL.Add('Select Senha from' +
                                              ' Administrador');
  // Ativa o SQL
  ...
  if Crypt(Name.Text) = DataModule1.ADOQuery1.FieldByName('Senha').AsString then
  begin
    RegisterUser.Make();
    // Informa que o usuário já existe
