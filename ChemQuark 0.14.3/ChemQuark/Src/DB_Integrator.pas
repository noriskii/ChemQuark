...
uses
  ...
  DBTables, Elementos, MMSystem, Vcl.CustomizeDlg;
...
type
  ...
  public
    ...
    function RemovePoints_( Text : String ) : Real;
    ...
    procedure SetMode( Kind : Byte );
    var Professor : Integer;
    var Mode      : Byte;
...
begin
  ...
  With Sender do
    begin
      ...
      DoubleBuffered := true;
      AlphaBlend := true;
      Sender.Icon.LoadFromFile('ChemQuark.ico');
      SetWindowLong(Sender.Handle, GWL_ExStyle, GetWindowLong(
      Sender.Handle, GWL_ExStyle) or WS_EX_AppWindow);
    end;
end;
